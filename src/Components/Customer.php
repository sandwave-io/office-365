...
final class Customer extends AbstractComponent
{
    ...
    {
        $tenantDomainOwnership = EntityHelper::deserializeArray(TenantDomainOwner::class, TenantDomainOwnerDataBuilder::build($customerId, $tenantId), RequestAction::TENANT_DOMAIN_OWNERSHIP_REQUEST_V1);
